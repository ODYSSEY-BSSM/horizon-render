...
`,pe=e=>{const r=se[e];return ce(r.fontSize,r.fontWeight,r.lineHeight,r.letterSpacing)},ue=new Set(["variant","color","width","textAlign","whiteSpace","ellipsis"]),fe=e=>!ue.has(e),ge=(e,r)=>e?{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}:{whiteSpace:r},he=c("div",{shouldForwardProp:fe})`
  ...
  ${({variant:e})=>pe(e)}
`,xe=e=>{const{element:r,styledProps:o,children:a,restProps:l}=ne(e);return i.jsx(he,{as:r,...o,...l,children:a})},R=xe,L={XS:{fontSize:"16px",fontWeight:"light",opticalSize:20},SM:{fontSize:"20px",fontWeight:"regular",opticalSize:24},MD:{fontSize:"24px",fontWeight:"regular",opticalSize:24},LG:{fontSize:"32px",fontWeight:"medium",opticalSize:40},XL:{fontSize:"40px",fontWeight:"semibold",opticalSize:48}},ve=(e,r,o,a=!1)=>d`
  font-size: ${e};
...
`,Se=(e,r=!1)=>{const o=L[e];return ve(o.fontSize,o.fontWeight,o.opticalSize,r)},$e=new Set(["variant","filled","size","color"]),me=e=>!$e.has(e),be=d`
...
`,ye=c("span",{shouldForwardProp:me})`
  ...
  ${({variant:e,filled:r})=>{const o=L[e];return d`
      ${Se(e,r)}
      font-variation-settings: 
...
`,G=g.forwardRef(function({name:r,variant:o="MD",filled:a=!1,size:l,color:n,as:p,decorative:u=!0,...s},f){const h=u?{"aria-hidden":!0}:{role:"img","aria-hidden":!1,"aria-label":("aria-label"in s?s["aria-label"]:void 0)??r};return i.jsx(ye,{as:p,ref:f,variant:o,filled:a,size:l,color:n,...h,...s,children:r})}),A=G,we=new Set(["length"]),V=e=>!we.has(e),ze=c("hr",{shouldForwardProp:V})`
  width: ${({length:e})=>e};
  border-top: ${t.stroke.weight} solid ${t.stroke.color};
`,Fe=c("div",{shouldForwardProp:V})`
  height: ${({length:e})=>e};
  display: inline-block;
  border-left: ${t.stroke.weight} solid ${t.stroke.color};
`,M=({orientation:e="horizontal",length:r="100%",...o})=>e==="vertical"?i.jsx(Fe,{...o,role:"separator","aria-orientation":"vertical",length:r}):i.jsx(ze,{...o,length:r});M.displayName="Divider";var lt=M,Ie={small:{fontSize:13,fontWeight:"semibold",lineHeight:18},medium:{fontSize:14,fontWeight:"semibold",lineHeight:20},large:{fontSize:16,fontWeight:"semibold",lineHeight:24}},ke=(e,r,o)=>d`
  font-size: ${t.fontSize[e]};
  font-weight: ${t.fontWeight[r]};
  line-height: ${t.lineHeight[o]};
  letter-spacing: 0;
...
`,N=c("button",{shouldForwardProp:Re})`
  ${Ne}
...
`,Ge=c.span`
  ${({size:e})=>Ce(e)}
`,Ve=({as:e,size:r="medium",iconPosition:o="none",variant:a="contained",rounded:l=!1,children:n,iconName:p="check",iconFilled:u=!1,disabled:s=!1,type:f="button","aria-label":h,onClick:$,onKeyDown:C,...D})=>{const m=e||"button",y=m==="button",T=m==="a"||"href"in D,b=o==="only"?i.jsx(H,{size:r,filled:u,children:p}):i.jsxs(i.Fragment,{children:[o==="left"&&i.jsx(H,{size:r,filled:u,"aria-hidden":!0,children:p}),n&&i.jsx(Ge,{size:r,children:n}),o==="right"&&i.jsx(H,{size:r,filled:u,"aria-hidden":!0,children:p})]}),x={size:r,variant:a,iconPosition:o,rounded:l,disabled:s,"aria-disabled":s,"aria-label":o==="only"?h||p:void 0,...y?{type:f}:{role:"button",tabIndex:s?-1:0}};return s&&T?i.jsx(N,{as:"span",...x,children:b}):i.jsx(N,{as:m,...x,children:b})},nt=Ve,Me=({id:e,value:r,defaultValue:o,onChange:a,onFocus:l,onBlur:n,error:p=!1,leftIcon:u,rightIcon:s,...f})=>{const h=g.useId(),$=e??h,C=`${$}-help`,[D,m]=g.useState(String(o??"")),[y,T]=g.useState(!1),[b,x]=g.useState(!1),w=r!==void 0?String(r):D,z=!!w.trim(),F=(f.type??"text")==="password",j=F,B=F||!!u,E=j||!!s,P=j?y?"text":"password":f.type,W=B?u??"lock":void 0,K=b?t.colors.primary[500]:p?t.colors.error[200]:z?t.colors.primary[500]:t.colors.neutral[300],X=z?t.colors.black:t.colors.neutral[400],q=g.useCallback(v=>{r===void 0&&m(v.target.value),a==null||a(v)},[r,a]),U=g.useCallback(v=>{x(!0),l==null||l(v)},[l]),Z=g.useCallback(v=>{x(!1),n==null||n(v)},[n]),Y=g.useCallback(()=>{T(v=>!v)},[]);return{id:$,helperId:C,value:w,isFocused:b,isFilled:z,isPassword:F,showPassword:y,hasToggle:j,hasLeft:B,hasRight:E,resolvedType:P,leftIconResolved:W,borderColor:K,affixColor:X,onChange:q,onFocus:U,onBlur:Z,togglePassword:Y}},Ke=new Set(["hasError","filled","hasLeft","hasRight","hasToggle"]),Xe=e=>!Ke.has(e),_=`
  position: absolute;
  top: 50%;
...
`,Je=`
  ...
  box-sizing: border-box;
  transition: all 0.2s ease-in-out;
`,Qe=(e,r)=>e&&r?"padding: 10px 36px;":e?"padding-left: 36px;":r?"padding-right: 36px;":"",et=(e,r)=>e?`box-shadow: inset 0 0 0 ${t.stroke.weight} ${t.colors.error[200]};`:r?`box-shadow: inset 0 0 0 ${t.stroke.weight} ${t.colors.primary[500]};`:`box-shadow: inset 0 0 0 ${t.stroke.weight} ${t.colors.neutral[300]};`,tt=c.output`
  text-align: left;
`,rt=c.div`
  display: flex;
...
`,at=c("input",{shouldForwardProp:Xe})`
  ...
  ${({filled:e,hasError:r})=>!r&&e&&d`
    ...
    `}
`,O=g.forwardRef((e,r)=>{const{id:o,helperId:a,value:l,isFilled:n,showPassword:p,hasToggle:u,hasLeft:s,hasRight:f,resolvedType:h,leftIconResolved:$,borderColor:C,affixColor:D,onChange:m,onFocus:y,onBlur:T,togglePassword:b}=Me(e),{label:x,helperText:w,error:z=!1,rightIcon:F,width:j,containerClassName:B,labelClassName:E,helperClassName:P,...W}=e;return i.jsxs(rt,{className:B,children:[x&&i.jsx(R,{as:"label",variant:"B1",color:C,htmlFor:o,className:E,children:x}),i.jsxs(ot,{width:j,children:[s&&$&&i.jsx(Ue,{"aria-hidden":!0,children:i.jsx(A,{name:$,variant:"SM",color:D})}),i.jsx(at,{...W,id:o,ref:r,type:h,hasError:z,filled:n,hasLeft:s,hasRight:f,hasToggle:u,onChange:m,onFocus:y,onBlur:T,"aria-invalid":z||void 0,"aria-describedby":w?a:void 0,value:l}),u?i.jsx(Ye,{type:"button",onClick:b,"aria-label":p?"비밀번호 숨기기":"비밀번호 표시",children:i.jsx(A,{name:p?"visibility":"visibility_off",variant:"SM",color:n?t.colors.black:t.colors.neutral[400]})}):F&&i.jsx(Ze,{"aria-hidden":!0,children:i.jsx(A,{name:F,variant:"SM",color:n?t.colors.black:t.colors.neutral[400]})})]}),w&&i.jsx(tt,{id:a,className:P,children:i.jsx(R,{variant:"B1",color:C,children:w})})]})});O.displayName="TextField";var st=O;G.__docgenInfo={description:"",methods:[],displayName:"Icon",props:{variant:{defaultValue:{value:'"MD"',computed:!1},required:!1},filled:{defaultValue:{value:"false",computed:!1},required:!1},decorative:{defaultValue:{value:"true",computed:!1},required:!1}}};O.__docgenInfo={description:"",methods:[],displayName:"TextField"};export{nt as B,lt as D,A as I,R as T,st as a};
